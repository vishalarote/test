...
public class EasyRatingDialog {
  ...
  private android.app.AlertDialog createDialog(Context context) {
    return new AlertDialog.Builder(context)
        ...
        .setMessage("Hi, take a minute to rate this app and help support to improve more new features. ;)")
       /* .setNegativeButton("Thanks", new DialogInterface.OnClickListener() {
        ...
        .setNeutralButton("Remince Me later", new DialogInterface.OnClickListener() {
          @Override
          public void onClick(DialogInterface dialogInterface, int i) {
            remindMeLater();
          }
