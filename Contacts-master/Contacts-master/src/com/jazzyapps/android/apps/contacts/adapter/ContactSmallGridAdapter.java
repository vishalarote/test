...
import com.jazzyapps.android.apps.contacts.adapter.holder.ContactHolder;
...
public class ContactSmallGridAdapter extends ContactBaseAdapter
{
	public ContactSmallGridAdapter()
	{
		super();
	}
	...
	protected int getLayoutRes()
	{
		if (CorePrefs.isRoundedPictures())
			return R.layout.item_contact_small_grid_rounded_item;
			
		return R.layout.item_contact_small_grid_item;
	}
