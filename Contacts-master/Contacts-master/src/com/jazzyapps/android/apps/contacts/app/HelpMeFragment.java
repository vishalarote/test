...
import com.jazzyapps.android.extended.util.AlertUtil;
import com.jazzyapps.android.extended.util.PlayStoreUtil;
...
public class HelpMeFragment extends BaseFragment
{
	...
	{
		PlayStoreUtil.openApp(getActivity(), "com.jazzyapps.klyph_beta");
	}

	private void openKlyphMessenger()
	{
		PlayStoreUtil.openApp(getActivity(), "com.jazzyapps.android.apps.klyph.messenger");
	}
