...
import com.jazzyapps.android.apps.contacts.search.utils.PinyinConverter;
...
public class SearchService extends AbstractSearchService {
	...
	public long rebuildCalllog(boolean urgent) {
		...
		Cursor cur = cr.query(Calls.CONTENT_URI, new String[] { Calls._ID, // 0
				...
				+ " LIMIT 200");
		// Ã¥ï¿½ÂªbuildÃ¦Å“â‚¬Ã¨Â¿â€˜Ã§Å¡â€ž200Ã¦ï¿½Â¡Ã©â‚¬Å¡Ã¨Â¯ï¿½Ã¨Â®Â°Ã¥Â½â€¢Ã¯Â¼Å’Ã¥Å Â Ã¥Â¿Â«Ã©â‚¬Å¸Ã¥ÂºÂ¦
		long hits = 0;
		try {
			indexWriter
...
//					log(TAG,"rebuild calllog:"+number+",boost:"+boost);
	...
	public long rebuildContacts(boolean urgent) {
		long start = System.currentTimeMillis();
		ContentResolver cr = this.context.getContentResolver();
		// Ã¥ï¿½â€“Ã¥Â¾â€”Ã§â€�ÂµÃ¨Â¯ï¿½Ã¦Å“Â¬Ã¤Â¸Â­Ã¥Â¼â‚¬Ã¥Â§â€¹Ã¤Â¸â‚¬Ã©Â¡Â¹Ã§Å¡â€žÃ¥â€¦â€°Ã¦Â â€¡Ã¯Â¼Å’Ã¥Â¿â€¦Ã©Â¡Â»Ã¥â€¦Ë†moveToNext()
		Cursor cur = cr
