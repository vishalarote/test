package com.jazzyapps.android.extended.widget;
...
public class MaxWidthFrameLayout extends FrameLayout
{
	...
	*/
	...
	@Override
	protected MaxWidthFrameLayout.LayoutParams generateDefaultLayoutParams()
	{
		return new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT);
	}

	@Override
	public MaxWidthFrameLayout.LayoutParams generateLayoutParams(AttributeSet attrs)
	{
		return new MaxWidthFrameLayout.LayoutParams(getContext(), attrs);
	}

	@Override
	protected FrameLayout.LayoutParams generateLayoutParams(ViewGroup.LayoutParams lp)
	{
		return new MaxWidthFrameLayout.LayoutParams(lp);
	}

	@Override
	protected boolean checkLayoutParams(ViewGroup.LayoutParams lp)
	{
		return lp instanceof MaxWidthFrameLayout.LayoutParams;
	}

	/**
	* Provides additional layout params (specifically {@link #maxWidth layout_maxWidth}) for
	* children of {@link MaxWidthFrameLayout}.
	*/
